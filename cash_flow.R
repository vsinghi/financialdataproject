...
{	
	...
	for (year in c(2014,2015,2016,2017,2018))  
	{
		...
		cf_df <- (subset(cf_df, Metric == "Net Income (Loss) Attributable to Parent" | Metric == "Depreciation and Impairment on Disposition of Property and Equipment" | Metric == "Amortization and Impairment of Intangible and Other Assets" | Metric == "Share-based Compensation" | Metric == "Amortization Of Debt Discount Premium" | Metric == "Increase (Decrease) in Receivable" | Metric == "Increase (Decrease) In Inventories" | Metric == "Increase (Decrease) In Property Subject To Or Available For Operating Lease" | Metric == "Increase (Decrease) In Prepaid Revenue Share Expenses And Other Assets" | Metric == "Increase (Decrease) in Accrued Liabilities" | Metric == "Increase (Decrease) in Deferred Revenue" | Metric = "Increase (Decrease) in Accounts Payable" | Metric = "Increase (Decrease) in Other Operating Assets and Liabilities, Net" | Metric == "Increase (Decrease) In Deferred Revenue And Customer Advances And Deposits" | Metric = "Increase (Decrease) In Other Noncurrent Liabilities" | Metric == "Net Cash Provided by (Used in) Operating Activities" | Metric == "Payments to Acquire Property, Plant, and Equipment" | Metric =="Net Cash Provided by (Used in) Investing Activities" | Metric == "Repayments of Long-term Debt, Long-term Capital Lease Obligations, and Capital Securities" | Metric == "Proceeds from (Repayments of) Short-term Debt, and Capital Securities" | Metric == "Cash and Cash Equivalents, Period Increase (Decrease)"))
		str1=year-1 
		str2="-01-01"
